...
_MODEL_CLASS_MAPPING = {
    "litellm": "gemmacode.models.litellm_model.LitellmModel",
    "litellm_textbased": "gemmacode.models.litellm_textbased_model.LitellmTextbasedModel",
    "litellm_response": "gemmacode.models.litellm_response_model.LitellmResponseModel",
    "openrouter": "gemmacode.models.openrouter_model.OpenRouterModel",
    "openrouter_textbased": "gemmacode.models.openrouter_textbased_model.OpenRouterTextbasedModel",
    "openrouter_response": "gemmacode.models.openrouter_response_model.OpenRouterResponseModel",
    "portkey": "gemmacode.models.portkey_model.PortkeyModel",
    "portkey_response": "gemmacode.models.portkey_response_model.PortkeyResponseAPIModel",
    "requesty": "gemmacode.models.requesty_model.RequestyModel",
    "deterministic": "gemmacode.models.test_models.DeterministicModel",
}
...
def get_model_class(model_name: str, model_class: str = "") -> type:
    ...
    e.g., "anthropic" or "gemmacode.models.anthropic.AnthropicModel"),
