...
subcommands = [
    ("gemmacode.run.utilities.config", ["config"], "Manage the global config file"),
    ("gemmacode.run.utilities.inspector", ["inspect", "i", "inspector"], "Run inspector (browse trajectories)"),
    ("gemmacode.run.benchmarks.swebench", ["swebench"], "Evaluate on SWE-bench (batch mode)"),
    ("gemmacode.run.benchmarks.swebench_single", ["swebench-single"], "Evaluate on SWE-bench (single instance)"),
]
