...
!!! note "LiteLLM Response API Model class"
    ...
    - [Read on GitHub](https://github.com/swe-agent/gemma-code/blob/main/src/gemmacode/models/litellm_response_model.py)

    ??? note "Full source code"

        ```python
        --8<-- "src/gemmacode/models/litellm_response_model.py"
        ```
...
::: gemmacode.models.litellm_response_model
